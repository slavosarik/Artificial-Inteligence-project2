...
public class GreedyPrehladavanie {
	...
	public void hladajCestu(Integer[] rozlozenie, Integer[] konecneRozlozenie,
		...
		System.out.println("Cas vykonavania prehladavania: " + time + " ms");
		...
		if (frontStav.peek() == null) {
			System.out
					.println("Cesta pre dane riesenie pomocu heuristiky neexistuje");
			System.out.println("Dosiahnuta maximalna hlbka: " + maxHlbka);
			return;
		}
		...
		System.out.println("Pocet navstivenych stavov: " + pocetKrokov);
		System.out.println("Dosiahnuta maximalna hlbka: " + maxHlbka);
		...
		System.out.println("Pocet pouzitych operatorov / hlbka: "
				+ kroky.size() + "\n" + kroky);
	}

	public static void main(String[] args) {
		GreedyPrehladavanie greedy = new GreedyPrehladavanie();
		...
		// rozmer hlavolamu
		final int puzzleSizeX = 3;
		final int puzzleSizeY = 3;

		Integer[] input = { 5, 6, 1, 4, 8, 0, 3, 2, 7  };
		Integer[] konecneRozlozenie = {1, 2, 3, 4, 5, 6, 7, 8, 0  };

		System.out
				.println("Greedy algoritmus použitím heuristiky Manhattanskych vzdialenosti:");
		greedy.hladajCestu(input, konecneRozlozenie, vzdialenosti, puzzleSizeX,
				puzzleSizeY);
		System.out
				.println("\nGreedy algoritmus použitím heuristiky poctu policok:");
		greedy.hladajCestu(input, konecneRozlozenie, pocetPolicok, puzzleSizeX,
				puzzleSizeY);
